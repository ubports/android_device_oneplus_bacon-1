...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/ubuntu/acdbdata/MTP/MTP_Bluetooth_cal.acdb:system/ubuntu/etc/acdbdata/MTP/MTP_Bluetooth_cal.acdb \
    $(LOCAL_PATH)/ubuntu/acdbdata/MTP/MTP_General_cal.acdb:system/ubuntu/etc/acdbdata/MTP/MTP_General_cal.acdb \
    $(LOCAL_PATH)/ubuntu/acdbdata/MTP/MTP_Global_cal.acdb:system/ubuntu/etc/acdbdata/MTP/MTP_Global_cal.acdb \
    $(LOCAL_PATH)/ubuntu/acdbdata/MTP/MTP_Handset_cal.acdb:system/ubuntu/etc/acdbdata/MTP/MTP_Handset_cal.acdb \
    $(LOCAL_PATH)/ubuntu/acdbdata/MTP/MTP_Hdmi_cal.acdb:system/ubuntu/etc/acdbdata/MTP/MTP_Hdmi_cal.acdb \
    $(LOCAL_PATH)/ubuntu/acdbdata/MTP/MTP_Headset_cal.acdb:system/ubuntu/etc/acdbdata/MTP/MTP_Headset_cal.acdb \
    $(LOCAL_PATH)/ubuntu/acdbdata/MTP/MTP_Speaker_cal.acdb:system/ubuntu/etc/acdbdata/MTP/MTP_Speaker_cal.acdb \
